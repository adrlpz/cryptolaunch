  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-10">
      <div className="mb-8">
        ...
        <h1 className="font-display text-3xl font-bold">Revenue Report</h1>
      </div>
      ...
      {loading ? (
        ...
        <>
          {/* Total */}
          <div className="mb-6 rounded-lg border border-profit/20 bg-profit-subtle p-6 text-center">
            <div className="text-xs text-muted">Total Revenue</div>
            <div className="mt-1 font-mono text-4xl font-bold text-profit">
          ...
          <div className="mb-6 grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                ...
                <div className={`mt-1 font-mono text-2xl font-bold ${card.color}`}>
                  {card.value}
                </div>
          ...
          <div className="mb-6 rounded-lg border border-edge bg-surface p-5">
            ...
            <div className="space-y-3">
              {[
                { label: "Margin Fee", percent: data.breakdown.marginPercent },
                { label: "Platform Fee", percent: data.breakdown.platformPercent },
                { label: "Trading Fee", percent: data.breakdown.tradingPercent },
                { label: "Deploy Fee", percent: data.breakdown.deployPercent },
              ].map((item) => (
                <div key={item.label}>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Cover losses when liquidation cannot execute in time.
                  Funded by 20% of platform fees.
                </p>
              </div>
            </div>
          </div>
